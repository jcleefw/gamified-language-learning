...
8. ✅ DS05 — learning-policy single source: server-owned `LEARNING_CONFIG` served read-only via `GET /api/config`; `srs-demo` drops its hardcoded copy and fetches at boot (fail-closed). Governed by the [Config Ownership & Layering ADR](../../../product-documentation/architecture/20260709T091559Z-engineering-config-ownership-and-layering.md) (Accepted) ([DS05](../../changelogs/EP37--refactor-learning-authority/20260709T085655Z-EP37-DS05-config-single-source.md))
