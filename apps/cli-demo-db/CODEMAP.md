...
| `@gll/srs-engine/learn` | learning-runner-db | Quiz batches, answer application, word state. |
| `@gll/srs-engine/review` | review-runner-db | Review scheduling (FsrsScheduler). |
| `@gll/srs-engine/shelving` | learning-runner-db | Shelving policy evaluation. |
