import type { AppDeck, AppLine } from './types'

const eatLines: AppLine[] = [
  {
...
export const eatDeck: AppDeck = {
  id: 'deck-eat',
  topic: "let's eat something",
  lines: eatLines,
}

export const weatherDeck: AppDeck = {
  id: 'deck-weather',
  topic: 'The weather is hot today',
  lines: weatherLines,
}

export const appDecks: AppDeck[] = [eatDeck, weatherDeck]
